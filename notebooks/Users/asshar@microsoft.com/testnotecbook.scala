...
val configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "1d676046-da15-4c87-8ef7-bb21b3c0743d",
...
dbutils.fs.mount(
  source = "abfss://data@datalakegen2storageash.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
val customersCsvLocation = "/mnt/data/*.csv"
val customers = 
  spark
    .read
